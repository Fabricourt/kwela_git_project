    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('listing', models.ForeignKey(help_text='particular listing assigned', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='listings.Listing')),
                ('realtor', models.ForeignKey(help_text='realtor assigned', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='realtors.Realtor')),
            ],
            options={
