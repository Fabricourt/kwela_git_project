    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bathrooms', models.ManyToManyField(help_text='Select how many bathrooms', to='houses.Bathroom')),
                ('bedroom', models.ManyToManyField(help_text='Select how many bedrooms', to='houses.Bedroom')),
