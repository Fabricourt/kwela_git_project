...
class Buyer(models.Model):
    ...
    def __str__(self):
         return f'{self.buyer.username} Buyer'

class Prospect(models.Model):
    prospect = models.ForeignKey(User, on_delete= models.CASCADE, null=True, blank=False)
    property_of_interest = models.ManyToManyField(Property_id, help_text='all properties bought by buyer')
    is_published = models.BooleanField(default=True)
    created_on = models.DateTimeField(default=timezone.now)
